...
if (!isset($_SESSION['login']) || $_SESSION['login'] !== true) {
    ...
    $page = "SELECT * FROM `req_book` WHERE `req_student_id` = '$s_id' ORDER BY req_id DESC";
    ...
    $sql = "SELECT * FROM `req_book` WHERE `req_student_id` = '$s_id' ORDER BY req_id DESC LIMIT $start_from,$num_per_page";
    ...
    if (isset($_POST['search_submit'])){
        ...
        $search = $_POST['search'];
        $sql= "SELECT * FROM `req_book` WHERE `book_name` LIKE '%$search%' AND `req_student_id` = '$s_id' ORDER BY req_id DESC LIMIT $start_from,$num_per_page";
...
<div class="container">
    ...
    <h3 style="text-align:center; padding-top:40px;"><b>My Request</b></h3>
    ...
    <div class="row">
        ...
        <div class="my-5">
            ...
            <form class="d-flex" role="search" action="my_req.php" method="POST">
                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()){
                            ...
                            $fill = "SELECT * FROM `req_fulfill` WHERE `req_id` = $req_id";

                            $fill_req = $conn->query($fill);

                            if($fill_req -> num_rows == 0){
                                $fill_or_not = 'No';
                            } else{
                                $fill_or_not = 'Yes';
                            }
                        ...
                        echo "
                            <tr>
                                <td>$row[book_name]</td>
                                <td>$row[date] <b>by</b> <a href='profile.php?student_id=$row[req_student_id]'>$row[req_student_id]</a></td>

                                <td>$fill_or_not</td>
                                
                                <td>
                                    <a class='btn btn-primary btn-sm' href='req_detail.php?req_id=$row[req_id]'>view</a>
                                </td>
                            </tr>
            ...
            <?php
              ...
              if($pages_pre < 1){
                  ...
                  echo"
                  <li class='page-item'>
                      <a class='page-link' href='my_req.php?pages=$pages_pre' aria-label='Previous'>
                          <span aria-hidden='true'>&laquo;</span>
                      </a>
                  </li>
              ...
              for($i = 1; $i <= $total_page; $i++){
                  ...
                  if($i == $pages){
                      ...
                      echo "               
                      <li class='page-item'>
                          <a class='page-link' href='my_req.php?pages=$i'>$i</a>
                      </li>
                      ";
                ...
                /*****************************************for next page*********************************************************** */
                  ...
                  if($pages_next > $total_page){
                      ...
                      echo"
                      <li class='page-item'>
                          <a class='page-link' href='my_req.php?pages=$pages_next' aria-label='Next'>
                              <span aria-hidden='true'>&raquo;</span>
                          </a>
                      </li>
