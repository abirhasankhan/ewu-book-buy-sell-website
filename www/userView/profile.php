...
if (!isset($_SESSION['login']) || $_SESSION['login'] !== true) {
    ...
    $start_from=($pages-1)*4;

    $page = "SELECT * FROM `booksell` WHERE `student_id` = '$s_id' ORDER BY sell_id DESC";
    ...
    $sql = "SELECT * FROM `booksell` WHERE `student_id` = '$s_id' ORDER BY sell_id DESC LIMIT $start_from,$num_per_page;";
    ...
    if (isset($_POST['search_submit'])){
        ...
        $search = $_POST['search'];
        $sql= "SELECT * FROM `booksell` WHERE `book_name` LIKE '%$search%' AND `student_id` = '$s_id' ORDER BY sell_id DESC LIMIT $start_from,$num_per_page;";
...
<div style="padding-bottom:100px">
    ...
    <div style="margin-left: 10%; margin-top: 50px;">
        <h3>Name: <?php echo $s_fName?> <?php echo $s_lName?></h3>
        <br>
        <h4>Email: <?php echo $s_email?></h4>
        <br>
        <h4>Phone Number:<?php echo $s_phoneNo?></h4>
     </div>
   

    <div style="margin-left: 10%; margin-right: 10%; margin-top: 50px;">
        <h4 style="text-align: center;"><b>My Book Upload</b></h4>
        <hr>
        ...
        <section>
            ...
            /*****************************************for Previous page*********************************************************** */
                                ...
                                if($pages_pre < 1){
                                    ...
                                    echo"
                                    <li class='page-item'>
                                        <a class='page-link' href='profile.php?pages=$pages_pre' aria-label='Previous'>
                                            <span aria-hidden='true'>&laquo;</span>
                                        </a>
                                    </li>
            ...
            /*****************************************for current and all  pages*********************************************************** */
                                ...
                                for($i = 1; $i <= $total_page; $i++){
                                    ...
                                    if($i == $pages){
                                        ...
                                        echo "               
                                        <li class='page-item'>
                                            <a class='page-link' href='profile.php?pages=$i'>$i</a>
                                        </li>
                                        ";
            ...
            /*****************************************for next page*********************************************************** */
                                    ...
                                    if($pages_next > $total_page){
                                        ...
                                        echo"
                                        <li class='page-item'>
                                            <a class='page-link' href='profile.php?pages=$pages_next' aria-label='Next'>
                                                <span aria-hidden='true'>&raquo;</span>
                                            </a>
                                        </li>
