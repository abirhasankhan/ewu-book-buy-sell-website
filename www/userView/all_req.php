...
if (!isset($_SESSION['login']) || $_SESSION['login'] !== true) {
    ...
    $sql = "SELECT * FROM `req_book` ORDER BY req_id DESC LIMIT $start_from,$num_per_page";
    ...
    if (isset($_POST['search_submit'])){
        ...
        $search = $_POST['search'];
        $sql= "SELECT * FROM `req_book` WHERE `book_name` LIKE '%$search%' ORDER BY req_id DESC LIMIT $start_from,$num_per_page";
...
<div class="container">
    ...
    <h3 style="text-align:center; padding-top:40px;"><b>All Book Request</b></h3>
    ...
    <div class="row">
        ...
        <div class="my-5">
            ...
            <form class="d-flex" role="search" action="all_req.php" method="POST">
